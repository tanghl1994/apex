...
__global__ void sgd_cuda_kernel(
        T* __restrict__ p,
...
//dispatch is done on the gradient type
            ...
            AT_DISPATCH_FLOATING_TYPES_AND_HALF(TypeShim(g.type()), "sgd_cuda_kernel", ([&] {
                using accscalar_t = at::acc_type<scalar_t, true>;
                sgd_cuda_kernel<accscalar_t, scalar_t><<<blocks,threadsPerBlock, 0, stream>>>(
                        p.data<accscalar_t>(),
            ...
            using namespace at;
            AT_DISPATCH_FLOATING_TYPES(TypeShim(g.type()), "sgd_cuda_kernel", ([&] {
                sgd_cuda_kernel<scalar_t, scalar_t><<<blocks,threadsPerBlock, 0, stream>>>(
                        p.data<scalar_t>(),
