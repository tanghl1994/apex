...
__global__ void com_sgd_kernel(
        T* __restrict__ p,
...
//dispatch is done on the gradient type
            ...
            AT_DISPATCH_FLOATING_TYPES_AND_HALF(TypeShim(g.type()), "com_sgd", ([&] {
                using accscalar_t = at::acc_type<scalar_t, true>;
                com_sgd_kernel<accscalar_t, scalar_t><<<blocks,threadsPerBlock, 0, stream>>>(
                        p.data<accscalar_t>(),
            ...
            using namespace at;
            AT_DISPATCH_FLOATING_TYPES(TypeShim(g.type()), "com_sgd_kernel", ([&] {
                com_sgd_kernel<scalar_t, scalar_t><<<blocks,threadsPerBlock, 0, stream>>>(
                        p.data<scalar_t>(),
