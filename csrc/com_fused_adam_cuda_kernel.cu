...
//dispatch is done on the gradient type
            ...
            AT_DISPATCH_FLOATING_TYPES_AND_HALF(TypeShim(g.type()), "com_adam_cuda_kernel", ([&] {
            ...
            using namespace at;
            AT_DISPATCH_FLOATING_TYPES(TypeShim(g.type()), "com_adam_cuda_kernel", ([&] {
                com_adam_cuda_kernel<scalar_t, scalar_t><<<blocks,threadsPerBlock, 0, stream>>>(
                        p.data<scalar_t>(),
