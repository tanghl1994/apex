...
class FP16_ECMomentum_Optimizer(object):
    """
    ...
    def step(self, closure=None, adam_freeze=False):
        ...
        #his_group = self.fp32_groups_flat[0].clone().detach()
        skip = self.optimizer.step(grads=[[g] for g in grads_groups_flat],
        ...
        #if adam_freeze:
         #   if dist.get_rank()==0:                
          #      print("Update is:   ", self.fp32_groups_flat[0][0:10]-his_group[0:10] ) 
